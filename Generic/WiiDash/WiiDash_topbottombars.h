...
WiiDash_spritetext(640-20,-70-trans+131-43,temptext,3);
...
strcat(temptext," AM");}
WiiDash_spritetext(640-20,-70-trans+131-23,temptext,3);

apply_surface(0,480-61+trans,WDtopbottomborderimage,screen,NULL);
WiiDash_spritetext(20,480-61+trans+3,(char*)WDextracredits,1);
WiiDash_spritetext(20,480-61+trans+23,(char*)"thatotherdev.wordpress.com",1);
